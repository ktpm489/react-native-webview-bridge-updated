...
public class AndroidWebViewModule extends ReactContextBaseJavaModule implements ActivityEventListener {
    ...
    public void send(String message) {
        ...
        reactContext.getJSModule(RCTEventEmitter.class).receiveEvent(this.webView.getId(), "topChange", event);
    }
    ...
    public void downloadFile() {
        DownloadManager dm = (DownloadManager) getActivity().getBaseContext()
